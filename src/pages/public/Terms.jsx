...
• Panelistan, stok durumuna göre siparişi iptal etme veya kısmi gönderim yapma hakkını saklı tutar. Bu durumda müşteri bilgilendirilir ve ödeme iade edilir.
...
Ürün fotoğrafları temsilidir; doğal ahşap ürünlerin renk ve doku farklılıkları olağandır ve iade gerekçesi oluşturmaz.`,
  },
  {
    ...
    content: `• Panelistan, web sitesinin kesintisiz veya hatasız çalışacağını garanti etmez.
    ...
    <div className="min-h-screen bg-[#FAF6F0] animate-page-in">
      <div className="bg-[#3D2914] py-16 sm:py-20 text-center">
        ...
        <p className="text-white/70 max-w-md mx-auto px-4">
          Panelistan web sitesini kullanım şartları.
        </p>
      </div>
